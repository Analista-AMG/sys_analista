...
def CargaNominaSeguimiento(fecha_fin):
    ...
    with engine.connect() as connection:
        with connection.begin() as transaction:
            ...
            transaction.commit()
    archivo_excel = fr"\\SRV-FS\Repositorio_Camp_AMG\\Seguimiento_Fija\{año}\{mesNombre}\nomina_{hoy.strftime('%Y%m')}.xlsx"
    ...
    if df_final is not None:
        try:
            ...
            excel_file_path = fr"\\SRV-FS\Repositorio_Camp_AMG\\Seguimiento_Fija\{año}\{mesNombre}\Consolidado {mesNombre}.xlsx"
    ...
    try:
        ...
        cursor.callproc('[[Sp_ActualizacionNomina_SeguimientoFija]]', parametros)
